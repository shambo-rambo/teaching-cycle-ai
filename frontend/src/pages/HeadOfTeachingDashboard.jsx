...
const HeadOfTeachingDashboard = () => {
  ...
  const loadDashboardData = async () => {
    try {
      const [frameworksResponse, statsResponse] = await Promise.all([
        apiCall('http://localhost:3001/api/frameworks?type=teaching'),
        apiCall('http://localhost:3001/api/frameworks/statistics')
      ]);
    ...
    <div className="min-h-screen bg-gray-50">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center py-4">
            <div className="flex items-center">
              ...
              <div>
                <h1 className="text-2xl font-bold text-gray-900">Teaching & Learning Dashboard</h1>
          ...
          <div className="border-b border-gray-200">
            <nav className="-mb-px flex space-x-8">
              {[
                ...
                { id: 'frameworks', label: 'My Frameworks', icon: BookOpen },
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
              ...
              <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
                <div className="bg-white p-6 rounded-lg shadow-sm border">
                  <div className="flex items-center">
                    ...
                    <div>
                      <p className="text-2xl font-bold text-gray-900">{statistics.byType.teaching || 0}</p>
                      <p className="text-gray-600">Teaching Frameworks</p>
                    </div>
                  </div>
                </div>
                ...
                <div className="bg-white p-6 rounded-lg shadow-sm border">
                  <div className="flex items-center">
                    ...
                    <div>
                      ...
                      <p className="text-gray-600">Active Frameworks</p>
                    </div>
                  </div>
                </div>
                ...
                <div className="bg-white p-6 rounded-lg shadow-sm border">
                  <div className="flex items-center">
                    ...
                    <div>
                      <p className="text-2xl font-bold text-gray-900">{statistics.mandatory || 0}</p>
                      <p className="text-gray-600">Mandatory Items</p>
                    </div>
                  </div>
                </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                ...
                >
                  ...
                  <div className="text-left">
                    <div className="font-medium text-purple-900">Create New Framework</div>
                    <div className="text-sm text-purple-600">Design teaching guidelines</div>
                  </div>
                </button>
                ...
                >
                  ...
                  <div className="text-left">
                    <div className="font-medium text-blue-900">Review Frameworks</div>
                    <div className="text-sm text-blue-600">Update existing guidelines</div>
                  </div>
                </button>
                ...
                >
                  ...
                  <div className="text-left">
                    ...
                    <div className="text-sm text-green-600">Check compliance data</div>
                  </div>
                </button>
              </div>
            </div>
            ...
            <div className="bg-white rounded-lg shadow-sm border p-6">
              ...
              <div className="space-y-4">
                {frameworks.slice(0, 5).map((framework) => (
                  <div key={framework.frameworkId} className="flex items-center justify-between p-3 bg-gray-50 rounded-lg">
                    <div className="flex items-center">
                      <div className={`w-3 h-3 rounded-full mr-3 ${
                        framework.status === 'active' ? 'bg-green-500' : 
                        framework.status === 'draft' ? 'bg-yellow-500' : 'bg-gray-500'
                      }`}></div>
                      <div>
                  ...
                  <div className="flex items-start justify-between">
                    <div className="flex-1">
                      <div className="flex items-center mb-2">
                        ...
                        <span className={`px-2 py-1 text-xs font-medium rounded-full border ml-2 ${getPriorityColor(framework.priority)}`}>
                ...
                <div className="bg-white rounded-lg shadow-sm border p-12 text-center">
                  ...
                  <p className="text-gray-500 mb-4">
                    {searchTerm || selectedFilter !== 'all' 
                      ...
                      : 'Create your first teaching framework to get started'
                    }
                  </p>
                  {!searchTerm && selectedFilter === 'all' && (
                    <button
        ...
        {activeTab === 'analytics' && (
          <div className="space-y-6">
            <div className="bg-white rounded-lg shadow-sm border p-6">
              <h3 className="text-lg font-semibold text-gray-900 mb-4">Framework Analytics</h3>
              <div className="text-center py-12">
                <BarChart3 className="w-12 h-12 text-gray-400 mx-auto mb-4" />
                <h4 className="text-lg font-medium text-gray-900 mb-2">Analytics Coming Soon</h4>
                <p className="text-gray-500">
                  Detailed compliance tracking and performance analytics will be available in the next release.
                </p>
              </div>
            </div>
          </div>
...
export default HeadOfTeachingDashboard;